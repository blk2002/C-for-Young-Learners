...
Page({
  ...
  goToLevels(e) {
    ...
    wx.navigateTo({
      url: `/pages/admin-exam-levels/admin-exam-levels?courseId=${this.data.courseId}&courseName=${encodeURIComponent(this.data.courseName)}&examType=${type}&examName=${encodeURIComponent(name)}`
    });
  }
});
